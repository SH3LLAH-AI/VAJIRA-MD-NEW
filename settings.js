...
const BOTNAME = 'cyber-MD|-sh3llah™';
const FOOTERNAME = '> cybershellah -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '263771341158' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LRdmkSBB#CZ3z-iQrggIYE9yr6GiVx-8YO7CRyxBhHMgo-3-QXYo`,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 shellah-  ＭＤ - Ｖ5 👨‍💻',    
